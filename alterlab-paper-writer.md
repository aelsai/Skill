...
```
alterlab-paper-writer + tw-hei-intelligence  -> Evidence-based HEI paper with real MOE data
alterlab-paper-writer + alterlab-deep-research        -> Deep research phase -> paper writing phase (auto-handoff)
alterlab-paper-writer + report-to-website    -> Interactive web version of the paper
alterlab-paper-writer + notebooklm-slides-generator -> Presentation slides from paper
...
| 2.0 | 2026-02 | NEW plan mode (Socratic guided chapter-by-chapter planning), alterlab-deep-research handoff protocol, Chinese APA 7.0 citation guide, failure path handling, mode selection guide |
